...
public class PackageCartActivity extends AppCompatActivity {
    ...
    public String TableName = "packages_cart";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CartTitle.setText("Package");
        //Log.d("p1_price",getIntent().getExtras().getString("p1_price"));
        //  createDatabase();
        PackageName = getIntent().getExtras().getString("list_item_name");
        PackageDescription = getIntent().getExtras().getString("package_desc");
        PackagePrice = getIntent().getExtras().getString("p1_price");
        health_institute_name = getIntent().getExtras().getString("p1_name");
        PackageId = getIntent().getExtras().getString("package_id");
        health_institute_id = getIntent().getExtras().getString("Health_Id");
        ...
        more_tests_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), PackageMoreActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_MULTIPLE_TASK);
                //intent.putExtra("Packagetype", 3 + "");
                intent.putExtra("TesttypeName", health_institute_name);
               ...
               /* Intent callIntent = new Intent(Intent.ACTION_DIAL);
                ...
                if (ActivityCompat.checkSelfPermission(PackageCartActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
...
//        toolbar.setNavigationIcon(getResources().getDrawable(android.R.drawable.));
        ...
        try {
            ...
            do {
                ...
                (child_view.findViewById(R.id.remove)).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        new AlertDialog.Builder(PackageCartActivity.this)
                ...
                if (Float.parseFloat(resultSet.getString(4)) != 0) {
                    ...
                    ((TextView) child_view.findViewById(R.id.cart_test_price)).setText("₹" + resultSet.getString(3));
    ...
    float calculatePrice(Cursor resultSet) {
        ...
        if (Float.parseFloat(resultSet.getString(4)) != 0) {
            //Log.d("dbdata1", resultSet.getString(3));
            Float total_value = Float.parseFloat(resultSet.getString(3));
            Float discount_val = Float.parseFloat(resultSet.getString(4));
            total_value = total_value - (total_value * (discount_val / 100));
    ...
    protected void insertIntoDB() {
        ...
        if (PackageName.equals("") || PackageId.equals("") || health_institute_name.equals("") || health_institute_id.equals("")) {
            Toast.makeText(getApplicationContext(), "Data not saved.", Toast.LENGTH_LONG).show();
            return;
        }
        ContentValues Package_datas = new ContentValues();

        Package_datas.put("item_id",PackageId);
        Package_datas.put("item_name",PackageName);
        Package_datas.put("item_price",PackagePrice);
        ...
        new AlertDialog.Builder(PackageCartActivity.this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        startActivity(new Intent(PackageCartActivity.this, LandingActivity.class)
