 ...
 */
public class TestProcessing extends Fragment {
    public Serverdatas sd;
    private DatabaseHelper DBhelper;
    public String TableName= "tests_cart";
    String name, mobile, email, address, appt_date, appt_time,pay,cost,coupon_code;
    private String TAG = "TestProcessing";
   // private String url1= "http://52.3.216.145/zywee_app/webservices/";
   String accessCode,merchantId,orderId,currency,amount,redirectUrl,cancelUrl,rsaKeyUrl;
    ...
    private class book extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... arg0) {
            ...
            try {
                Cursor resultSet = DBhelper.getTableData(TableName);
                ...
                if (resultSet.moveToFirst()) {
                    do {
                        ...
                        //appt_data.put("value",Float.parseFloat(cost));
            ...
            nameValuePair.add(new BasicNameValuePair("collection_cost",cost));
