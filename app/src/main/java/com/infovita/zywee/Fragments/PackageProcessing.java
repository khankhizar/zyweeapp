 ...
 */
public class PackageProcessing extends Fragment {
    public Serverdatas sd;
    private DatabaseHelper DBhelper;

    public String TableName= "packages_cart";
    String name, mobile, email, address, appt_date, appt_time,coupon_code;
    private String TAG = "PackageProcessing";
           ...
           /* if (pay.equals("pay later")) {
            ...
            try {
                ...
                if (jsonStr != "") {
                    ...
                    edit.putString(AvenuesParams.AMOUNT,ServiceUtility.chkNull(value).toString().trim());
                    edit.commit();
                    Log.d("amount",ServiceUtility.chkNull(value).toString().trim());
                    return 1;
                } else {
                    hideProgressDiaalog();
                    return -1;
